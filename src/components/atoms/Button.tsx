...
export function Button({
  ...
  const colorVariants = {
    sky: {
      ...
      } border-sky-500 bg-sky-500 text-white hover:bg-sky-50 hover:text-sky-950 focus:ring-sky-300`,
      outline:
    ...
    sand: {
      filled: `${
        border ? "border-2" : "border-0"
      } border-sand-500 bg-sand-500 text-white hover:bg-sand-50 hover:text-sand-950 focus:ring-sand-300`,
      outline:
    ...
    water: {
      filled: `${
        border ? "border-2" : "border-0"
      } border-water-500 bg-water-500 text-white hover:bg-water-50 hover:text-water-950 focus:ring-water-300`,
      outline:
    ...
    red: {
      filled: `${
        border ? "border-2" : "border-0"
      } border-red-600 bg-red-600 text-white hover:bg-red-700 focus:ring-red-300`,
      outline:
    ...
    gray: {
      filled: `${
        border ? "border-2" : "border-0"
      } border-gray-500 bg-gray-500 text-white hover:bg-gray-700 focus:ring-gray-300`,
      outline:
